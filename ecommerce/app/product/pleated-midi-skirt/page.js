          ...
          <div className="container mx-auto px-4">
            <nav className="text-sm">
              <ol className="flex items-center space-x-2">
                ...
                <li className="text-muted-foreground">/</li>
                <li>
                  <Link href="/shop/women/skirts" className="text-muted-foreground hover:text-primary">
                    Women's Skirts
                  </Link>
                </li>
                <li className="text-muted-foreground">/</li>
                <li className="font-medium">Pleated Midi Skirt</li>
              </ol>
            </nav>
          </div>
        </div>
        ...
        <section className="py-12">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
              ...
              {/* Product Info */}
              <div>
                <h1 className="text-3xl font-bold mb-2">Pleated Midi Skirt</h1>
                <div className="flex items-center mb-4">
                  ...
                  <span className="text-sm text-muted-foreground ml-2">4.7 (18 reviews)</span>
                </div>
                <div className="text-2xl font-bold mb-6">$44.99</div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="flex space-x-2">
                      <button className="w-8 h-8 rounded-full bg-black border-2 border-primary flex items-center justify-center">
                        <span className="sr-only">Black</span>
                      </button>
                      <button className="w-8 h-8 rounded-full bg-blue-900 border border-muted">
                        <span className="sr-only">Navy</span>
                      </button>
                      <button className="w-8 h-8 rounded-full bg-amber-100 border border-muted">
                  ...
                  <div className="space-y-4 pt-6">
                    ...
                    <div className="text-sm text-muted-foreground">
                      <p>
                        This elegant pleated midi skirt features fine accordion pleats that create 
                        beautiful movement as you walk. The high-waisted design is flattering and 
                        comfortable, with an elastic waistband that provides the perfect fit. 
                        The lightweight fabric drapes beautifully and is perfect for both casual 
              ...
              {[2, 3, 4, 5].map((item) => (
                <div key={item} className="bg-background rounded-lg overflow-hidden">
                  <div className="aspect-square overflow-hidden">
                    <img
                      src={`/product-skirt-${item > 6 ? 1 : item}.jpg`}
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-sm text-muted-foreground">Skirts</p>
                    <div className="mt-2 font-semibold">$39.99</div>
                  </div>
                </div>
              ))}
            </div>
